...
public class ColorUtils {
    ...
    public static void initColorList() {
        if (predefinedList) {
            ...
            colorList.add(new ColorName("Deep SkyBlue", 0x00, 0xBF, 0xFF));
            ...
            for (int i = 0; i < ImagePointsSourceProvider.colors.length; i++) {
                Color color = ImagePointsSourceProvider.colors[i];
                ColorName colorName = new ColorName(ImagePointsSourceProvider.colorNames[i],
     ...
     * @param g green
     * @param b blue
     * @return closest match color name
     */
    ...
    public static Color getColorFromColorName(String name) {
     ...
     * @author Xiaoxiao Li
     */
    private record ColorName(String name, int r, int g, int b) {
